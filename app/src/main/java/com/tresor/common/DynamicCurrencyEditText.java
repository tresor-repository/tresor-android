...
/**
 * Created by kris on 7/19/17. Tokopedia
 */

public class DynamicCurrencyEditText extends android.support.v7.widget.AppCompatEditText{
    ...
    public DynamicCurrencyEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
